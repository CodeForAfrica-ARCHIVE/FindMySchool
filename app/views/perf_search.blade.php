...
@section('title')
	Search - <?php echo ucwords(strtolower(urldecode($search_term))); ?> | FMS.Ke
@stop
	...
	<section class="container">
		...
		<div class="row">
			<div class="span6">
				...
				<div id="pri-schools">
					<p>
						<img src="/assets/img/spinner.gif" alt=""> Finding Schools...
					</p> 
				</div>
			</div>
			<div class="span6">
				...
				if (xmlhttp.readyState==4 && xmlhttp.status==200) {
					...
					if (json_pri.length === 0){
						...
						for (var i = 0; i<json_pri.length; i++){
							if (json_pri[i]['district_name']==null) {
								json_pri[i]['district_name'] = 'N/A';
							}
							pri_res += "<li><a href=\"/performance/school/pri:2011:"+
								json_pri[i]['school_code']+"\">"+
								"<p style=\"display:inline-block;\">"+toTitleCase(json_pri[i]['school_name'])+"</p></a> "+
					...
					if (json_sec.length === 0){
						...
						for (var i = 0; i<json_sec.length; i++){
							sec_res += "<li><a href=\"/performance/school/sec:"+
